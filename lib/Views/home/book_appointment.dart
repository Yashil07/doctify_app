                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text("Select Appointment Date",
                                        style: FontTextStyle.poppinsS12W7labelColor),
                                    SizedBox(height: 2.h),
                                    GestureDetector(
                                      onTap: () {
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              "Voice Call",
                                              style:
                                                  FontTextStyle.poppinsS12W5labelColor,
                                            ),
                                            SizedBox(height: 1.h),
                                            Text(
                                              "Voice Call With Doctor",
                                              style:
                                                  FontTextStyle.poppinsS8W5labelColor,
                                            ),
                                          ],
                                        ),
                                        Text(
                                          "₹1000",
                                          style: FontTextStyle.poppinsS14W4PrimaryColor,
                                        ),
                                      ],
                                    ),
                                  ),
  ...
  Future<void> _openBirthDatePicker(BuildContext context) async {
    ...
    if (_newDate != null) {
      setState(() {
        ...
        if (aDate != "") {
          DateTime parseDate = new DateFormat("MM-dd-yyyy").parse(aDate);
          var inputDate = DateTime.parse(parseDate.toString());
          var outputFormat = DateFormat('EEEE, MMM dd, yyyy');
          aDate = outputFormat.format(inputDate);
        }
      });
    }
  }
